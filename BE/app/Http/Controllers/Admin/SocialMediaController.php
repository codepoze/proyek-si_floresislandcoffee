...
class SocialMediaController extends Controller
{
    ...
    {
        return Template::load('admin', 'Social Media', 'social_media', 'view');
    }
    ...
    public function list()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                return '
                    <button type="button" id="upd" data-id="' . my_encrypt($row->id_social_media) . '" class="btn btn-sm btn-action btn-relief-primary" data-bs-toggle="modal" data-bs-target="#modal-add-upd"><i data-feather="edit"></i>&nbsp;<span>Ubah</span></button>&nbsp;
                    <button type="button" id="del" data-id="' . my_encrypt($row->id_social_media) . '" class="btn btn-sm btn-action btn-relief-danger"><i data-feather="trash"></i>&nbsp;<span>Hapus</span></button>
                ';
            })
            ->rawColumns(['action'])
            ->make(true);
