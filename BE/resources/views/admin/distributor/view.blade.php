<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-distributor-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('admin.distributor.save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" id="nama" name="nama" placeholder="Masukkan nama distributor" />
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-distributor-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
                ...
                ajax: "{{ route('admin.distributor.list') }}",
        ...
        let untukTambahData = function() {
            $(document).on('click', '#add', function(e) {
                ...
                $('#id_distributor').removeAttr('value');
        ...
        let untukUbahData = function() {
            $(document).on('click', '#upd', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: "{{ route('admin.distributor.show') }}",
                    data: {
                        id: ini.data('id')
                    },
                    beforeSend: function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            $.ajax({
                                type: "post",
                                url: "{{ route('admin.distributor.del') }}",
                                dataType: 'json',
                                data: {
                                    id: ini.data('id'),
