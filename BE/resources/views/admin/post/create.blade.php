        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="form-add-upd" class="form form-horizontal mt-2" action="{{ route('admin.post.store') }}" method="POST">
                            <!-- begin:: id -->
                            ...
                            <div class="field-input mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" id="title" name="title" placeholder="Masukkan judul" />
                            ...
                            <div class="field-input mb-1 row">
                                ...
                                <div class="col-sm-9 my-auto">
                                    <select class="form-select form-select-sm" id="id_tag" name="id_tag[]" multiple>
                                        <option value=""></option>
                                        @foreach ($tag as $item)
                                        <option value="{{ $item->id_tag }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback"></div>
                                </div>
                            ...
                            <div class="field-input mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control form-control-sm" id="content" name="content" placeholder="Masukkan konten"></textarea>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="row">
