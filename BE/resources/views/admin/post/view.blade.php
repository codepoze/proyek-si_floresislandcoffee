            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <div class="dt-action-buttons text-end">
                            <div class="dt-buttons d-inline-flex">
                                <a href="{{ route('admin.post.create') }}" class="btn btn-sm btn-relief-success">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-post-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
