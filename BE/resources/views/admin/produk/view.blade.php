<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-produk-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('admin.produk.save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="id_satuan" id="id_satuan" class="form-control form-control-sm">
                                                ...
                                                <option value="{{ $row->id_satuan }}">{{ $row->nama }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    ...
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" id="tipe" name="tipe" placeholder="Masukkan tipe" />
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="field-input mb-1 row">
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-produk-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
