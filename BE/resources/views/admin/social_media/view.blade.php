<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-social_media-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('admin.social_media.save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" id="link" name="link" placeholder="Masukkan link" />
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-social_media-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
                ...
                ajax: "{{ route('admin.social_media.list') }}",
        ...
        let untukTambahData = function() {
            $(document).on('click', '#add', function(e) {
                ...
                $('#id_social_media').removeAttr('value');
