<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-subscriber-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-subscriber-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
                ...
                ajax: "{{ route('admin.subscriber.list') }}",
