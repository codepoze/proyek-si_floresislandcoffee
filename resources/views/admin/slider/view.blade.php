<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-slider-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('admin.slider.save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" id="judul" name="judul" placeholder="Masukkan judul slider" />
                                    ...
                                    <div class="col-12">
                                        <div class="field-input mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control form-control-sm" id="deskripsi" name="deskripsi" placeholder="Masukkan deskripsi slider"></textarea>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-slider-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
            ...
            $(document).on('click', '#upd', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#centang_gambar').html(`<div class="form-check form-check-inline"><input type="checkbox" class="form-check-input" name="change_picture" id="change_picture" onclick="change('change_picture', 'gambar')"><label class="form-check-label">Ubah Gambar!</label></div>`);
